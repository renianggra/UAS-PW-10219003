	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				<img src="dist/img/bg1.jpg" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
				<span class="brand-text"> SIMPEG IT</span>
			</a>
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-2 pb-2 mb-2 d-flex">
					...
					<div class="info">
						<a href="index.php">
							<?php echo $data_nama=="Reni Anggraeni"; ?>
						</a>
